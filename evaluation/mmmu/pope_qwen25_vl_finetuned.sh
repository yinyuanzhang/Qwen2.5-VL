...
ANSWERS_FILE="$AUTO_DL_TMP/playground/data/eval/pope/answers/qwen25-vl-3b-pope-origin-$(date +%Y%m%d-%H%M%S).jsonl" # Unique filename with timestamp
...
export CUDA_VISIBLE_DEVICES="3" # 指定使用 GPU 0
